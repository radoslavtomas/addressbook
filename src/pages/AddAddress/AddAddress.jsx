        ...
        <Box maxW="350px" mx="auto">
          <form>
            <FormControl mb={4} isRequired isInvalid={formik.touched.address_line_1 && formik.errors.address_line_1}>
              <FormLabel htmlFor="address_line_1">{t('addAddress.form.address_line_1')}</FormLabel>
              <Input
                id="address_line_1"
                type="text"
            ...
            <FormControl mb={4} isRequired isInvalid={formik.touched.address_line_2 && formik.errors.address_line_2}>
              <FormLabel htmlFor="address_line_2">{t('addAddress.form.address_line_2')}</FormLabel>
              <Input
                id="address_line_2"
                type="text"
                errorBorderColor="red.400"
            ...
            <FormControl mb={4} isRequired isInvalid={formik.touched.address_line_3 && formik.errors.address_line_3}>
              <FormLabel htmlFor="address_line_3">{t('addAddress.form.address_line_3')}</FormLabel>
              <Input
                id="address_line_3"
                type="text"
                errorBorderColor="red.400"
            ...
            <FormControl mb={4} isRequired isInvalid={formik.touched.address_line_4 && formik.errors.address_line_4}>
              <FormLabel htmlFor="address_line_4">{t('addAddress.form.address_line_4')}</FormLabel>
              <Input
                id="address_line_4"
                type="text"
                errorBorderColor="red.400"
            ...
            <FormControl mb={4} isRequired isInvalid={formik.touched.postcode && formik.errors.postcode}>
              <FormLabel htmlFor="postcode">{t('addAddress.form.postcode')}</FormLabel>
              <Input
                id="postcode"
                type="text"
                errorBorderColor="red.400"
            ...
            <FormControl mb={4} isInvalid={formik.touched.country && formik.errors.country}>
              <FormLabel htmlFor="country">{t('addAddress.form.country')}</FormLabel>
              <Select
